# ===========================================
# WP Theme Symlink Script (Project-specific)
# ===========================================

# >>> ENTER PROJECT PATHS HERE <<<
$Source = "your-source-folder\_wp-content-dev\boilerplate-theme\theme"
$Target = "your-target-folder\wp-content\themes\boilerplate-theme"
